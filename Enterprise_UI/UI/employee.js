                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="p-2 w-50 bd-highlight">
                                <img alt="profile pic" width="250px" height="250px" 
                                    :src="PhotoPath+PhotoFileName">
                                <input class="m-2" type="file" @change="imageUpload">
                            </div>
                        </div>
                        <button type="button" 
                        @click="createClick()" v-if="EmployeeId==0" class="btn btn-primary">
                            Create
                        </button>
                        <button type="button" 
                        @click="updateClick()" v-if="EmployeeId!=0" class="btn btn-primary">
                            Update
                        </button>
                    </div>
                </div>
